...
class Kyra {
  constructor(options = {}) {
    const {
      ...
      endpoint = process.env.KYRA_ENDPOINT || 'https://kitkat-production.up.railway.app/api',
      project = process.env.KYRA_PROJECT || 'default',
      tracingEnabled = process.env.KYRA_TRACING !== 'false',
    } = options;
    
    if (!apiKey) throw new Error('KYRA_API_KEY required');
